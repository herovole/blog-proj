...
public abstract class PaginatedResultSet<I, O> {
    ...
    public PaginatedResultSet(long numberOfRecords, int recordsPerPage) throws DomainInstanceGenerationException {
    ...
    public synchronized O next() throws DomainInstanceGenerationException {
    ...
    private synchronized void reload() throws DomainInstanceGenerationException {
