...
public class ProcessPostUserCommentInput {
    ...
    public static class Builder {
        ...
        public ProcessPostUserCommentInput build() {
            if (iPv4Address == null || uuId == null || verificationToken == null || formContent == null) {
                throw new IllegalStateException(ProcessPostUserCommentInput.class.getSimpleName() + "Invalid building process.");
            }
            ...
            return new ProcessPostUserCommentInput(
                    iPv4Address,
                    uuId,
                    verificationToken,
